...
public class ChannelsServiceImpl implements ChannelsService {
    ...
    public Channels update(Channels channels) {
        ...
        if(repses != null && Hibernate.isInitialized(repses)) {
            repses.forEach(_reps -> _reps.setChannels(channels));
        }
    ...
    public void export(ExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service salesdb for table Channels to {} format", options.getExportType());
