...
public class LeadsController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StringWrapper exportLeadsAndGetURL(@RequestBody ExportOptions options, Pageable pageable) {
        String url = exportedFileManager.registerAndGetURL(Leads.class.getSimpleName() + options.getExportType().getExtension(), outputStream -> leadsService.export(options, pageable, outputStream));
