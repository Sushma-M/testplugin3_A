...
public interface EmployeeService {
     ...
     *
     * @param eid value of eid; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     ...
     * @see Page
     */
    Page<Vacation> findAssociatedVacations(Integer eid, Pageable pageable);
     ...
     * @see Page
     */
    Page<Employee> findAssociatedEmployeesForManagerid(Integer eid, Pageable pageable);
