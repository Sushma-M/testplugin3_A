...
public interface UserService {
     ...
     *
     * @param userIds The id's of the User to get; value cannot be null.
     * @param orderedReturn Should the return List be ordered and positional in relation to the incoming ids?
     * @return Users associated with the given userIds.
     */
    List<User> findByMultipleIds(List<Integer> userIds, boolean orderedReturn);
