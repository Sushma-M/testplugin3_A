...
public class HrdbQueryExecutorServiceImpl implements HrdbQueryExecutorService {
    ...
    public Page<EmpCountResponse> executeEmpCount(Pageable pageable) {
        ...
        return queryExecutor.executeNamedQuery("empCount", params, EmpCountResponse.class, pageable);
    }

    @Transactional(readOnly = true, value = "hrdbTransactionManager")
    @Override
    public Downloadable exportEmpCount(ExportType exportType, Pageable pageable) {
        Map params = new HashMap(0);


        return queryExecutor.exportNamedQueryData("empCount", params, exportType, EmpCountResponse.class, pageable);
    }
