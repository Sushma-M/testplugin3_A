...
public class DepartmentController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StringWrapper exportDepartmentsAndGetURL(@RequestBody ExportOptions options, Pageable pageable) {
        String url = exportedFileManager.registerAndGetURL(Department.class.getSimpleName() + options.getExportType().getExtension(), outputStream -> departmentService.export(options, pageable, outputStream));
