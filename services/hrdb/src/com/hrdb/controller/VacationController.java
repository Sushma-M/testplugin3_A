...
public class VacationController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StringWrapper exportVacationsAndGetURL(@RequestBody ExportOptions options, Pageable pageable) {
        String url = exportedFileManager.registerAndGetURL(Vacation.class.getSimpleName() + options.getExportType().getExtension(), outputStream -> vacationService.export(options, pageable, outputStream));
