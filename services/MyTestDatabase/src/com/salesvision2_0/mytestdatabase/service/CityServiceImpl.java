...
public class CityServiceImpl implements CityService {
    ...
    public City findById(Integer cityId) {
        ...
        try {
            ...
            LOGGER.debug("No City found with id: {}", cityId, ex);
            return null;
        }
    }
    ...
    @Transactional(readOnly = true, value = "MyTestDatabaseTransactionManager")
    @Override
    public List<City> findByMultipleIds(List<Integer> cityIds, boolean orderedReturn) {
        LOGGER.debug("Finding Cities by ids: {}", cityIds);

        return this.wmGenericDao.findByMultipleIds(cityIds, orderedReturn);
    }
    ...
    public City update(City cityInstance) {
        ...
        List<Personnel> personnels = cityInstance.getPersonnels();
        if(personnels != null && Hibernate.isInitialized(personnels)) {
            personnels.forEach(_personnel -> _personnel.setCity(cityInstance));
        }
    ...
    @Transactional(value = "MyTestDatabaseTransactionManager")
    @Override
    public City delete(Integer cityId) {
    ...
    public void export(ExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service MyTestDatabase for table City to {} format", options.getExportType());
