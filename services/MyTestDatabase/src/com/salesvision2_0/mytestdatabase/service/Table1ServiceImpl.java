...
public class Table1ServiceImpl implements Table1Service {
    ...
    public Table1 update(Table1 table1) {
        ...
        List<Table2> table2s = table1.getTable2s();
        if(table2s != null && Hibernate.isInitialized(table2s)) {
            table2s.forEach(_table2 -> _table2.setTable1(table1));
        }
    ...
    public void export(ExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service MyTestDatabase for table Table1 to {} format", options.getExportType());
    ...
    @Transactional(readOnly = true, value = "MyTestDatabaseTransactionManager")
    @Override
    public Page<Table2> findAssociatedTable2s(Integer id, Pageable pageable) {
        LOGGER.debug("Fetching all associated table2s");

        StringBuilder queryBuilder = new StringBuilder();
        queryBuilder.append("table1.id = '" + id + "'");
