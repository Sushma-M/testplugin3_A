...
public class Table1Controller {
    ...
    @RequestMapping(value="/{id:.+}/table2s", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the table2s instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Table2> findAssociatedTable2s(@PathVariable("id") Integer id, Pageable pageable) {

        LOGGER.debug("Fetching all associated table2s");
        return table1Service.findAssociatedTable2s(id, pageable);
    }
